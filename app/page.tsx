...
const Model3DViewer = dynamic(() => import("@/components/3d-model-viewer"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full bg-gradient-to-br from-teal-50 to-blue-50 rounded-3xl flex items-center justify-center">
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section id="accueil" className="bg-teal-800 text-white py-12 md:py-20 relative overflow-hidden">
        {/* Animated background */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div
              className={`space-y-6 order-2 lg:order-1 transition-all duration-1000 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}
            >
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                <TypingEffect text={t("heroTitle")} speed={80} />
              </h1>
              <p
                className={`text-base md:text-lg text-teal-100 leading-relaxed max-w-md transition-all duration-1000 delay-500 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-5 opacity-0"}`}
              >
                {t("heroDescription")}
              </p>
              <div
              ...
              >
                <Link href="/auth">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-teal-500 hover:bg-teal-600 text-white px-6 md:px-8 py-3 rounded-full hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl group"
                  >
                    {t("startNow")}
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto border-white text-white hover:bg-white hover:text-teal-800 px-6 md:px-8 py-3 rounded-full bg-transparent hover:scale-105 transition-all duration-300"
                >
                  {t("learnMore")}
                </Button>
              </div>
              ...
              >
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-teal-200">
                    <AnimatedCounter end={10000} suffix="+" />
                  </div>
                  <div className="text-xs md:text-sm text-teal-300">{t("patients")}</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-teal-200">
                    <AnimatedCounter end={95} suffix="%" />
                  </div>
                  <div className="text-xs md:text-sm text-teal-300">{t("satisfaction")}</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-teal-200">
                    <AnimatedCounter end={24} suffix="/7" />
                  </div>
                  <div className="text-xs md:text-sm text-teal-300">{t("available")}</div>
                </div>
              </div>
            </div>
            ...
            {/* 3D Model Section */}
            <div
              className={`relative order-1 lg:order-2 transition-all duration-1000 delay-300 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"}`}
            >
              <div className="w-full h-64 md:h-80 lg:h-96 xl:h-[500px] relative">
                <Suspense
                  fallback={
                    <div className="w-full h-full bg-gradient-to-br from-teal-50 to-blue-50 rounded-3xl flex items-center justify-center">
                      <div className="flex flex-col items-center space-y-4">
                        <div className="w-12 h-12 border-4 border-teal-200 border-t-teal-600 rounded-full animate-spin"></div>
                        <p className="text-teal-600 font-medium">Chargement...</p>
                      </div>
                    </div>
                  }
                >
      ...
      {/* Features Section */}
      <section id="features" className="bg-pink-50 py-12 md:py-20 relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 max-w-4xl mx-auto animate-fade-in-up px-4">
              {t("featuresTitle")}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <Card
                key={index}
                className={`text-center p-6 md:p-8 border-0 shadow-sm bg-white hover:shadow-xl transition-all duration-500 hover:scale-105 animate-fade-in-up ${feature.delay} group`}
              >
                <CardContent className="space-y-4">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-100 rounded-lg flex items-center justify-center mx-auto group-hover:bg-teal-100 transition-colors duration-300">
                    <feature.icon className="h-6 w-6 md:h-8 md:w-8 text-gray-600 group-hover:text-teal-600 transition-colors duration-300" />
                  </div>
                  <h3 className="text-base md:text-lg font-bold text-gray-900 group-hover:text-teal-800 transition-colors duration-300">
                    {feature.title}
                  </h3>
      ...
      {/* Precision Section */}
      <section id="precision" className="bg-white py-12 md:py-20 relative overflow-hidden">
        {/* Floating elements */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="animate-fade-in-left">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-6 animate-fade-in-up delay-100">
                {t("precisionTitle")}
              </h2>
              <p className="text-gray-600 text-base md:text-lg mb-8 animate-fade-in-up delay-200">
                {t("precisionDesc")}
              </p>
            ...
            <div className="relative animate-fade-in-right">
              <div className="bg-gray-200 rounded-3xl aspect-square flex items-center justify-center relative overflow-hidden group">
                ...
                <div className="w-16 h-16 md:w-24 md:h-24 bg-gray-400 rounded-lg flex items-center justify-center relative z-10 transition-transform group-hover:scale-110 duration-300">
                  <Image
      ...
      {/* Features Grid */}
      <section id="support" className="bg-blue-50 py-12 md:py-20 relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 animate-fade-in-up">
              {t("supportFeaturesTitle")}
            </h2>
            <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto animate-fade-in-up delay-200 px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                <CardContent className="space-y-4">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-100 rounded-lg flex items-center justify-center mx-auto group-hover:bg-blue-100 transition-colors duration-300">
                    <feature.icon className="h-6 w-6 md:h-8 md:w-8 text-gray-600 group-hover:text-blue-600 transition-colors duration-300" />
                  </div>
                  <h3 className="text-base md:text-lg font-bold text-gray-900 group-hover:text-blue-800 transition-colors duration-300">
                    {feature.title}
                  </h3>
                  <p className="text-gray-600 text-sm">{feature.description}</p>
                </CardContent>
          ...
          <div className="text-center mt-8 md:mt-12 animate-fade-in-up delay-700">
      ...
      <section className="bg-white py-12 md:py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 animate-fade-in-up">{t("ctaTitle")}</h2>
          <p className="text-gray-600 text-base md:text-lg mb-8 animate-fade-in-up delay-200 px-4">{t("ctaDesc")}</p>
          <Link href="/auth" className="animate-fade-in-up delay-400 inline-block">
            <Button
              size="lg"
              className="bg-teal-500 hover:bg-teal-600 text-white px-6 md:px-8 py-3 rounded-full hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
            >
              {t("getStarted")}
              <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
            </Button>
      ...
      <section id="about" className="bg-gray-50 py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="mb-12 animate-fade-in-up">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{t("healthResources")}</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                <div className="bg-gray-200 h-32 md:h-48 flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-400/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-400 rounded-lg flex items-center justify-center relative z-10 transition-transform group-hover:scale-110 duration-300">
                    <Image
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2 group-hover:text-teal-800 transition-colors duration-300">
                    {article.title}
                  </h3>
      ...
      {/* Footer */}
      <footer className="bg-teal-800 text-white py-12 md:py-16 relative overflow-hidden">
        {/* Animated background */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="border-t border-teal-700 mt-8 md:mt-12 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in-up delay-600">
            <p className="text-teal-200 text-sm mb-4 md:mb-0">{t("copyright")}</p>
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
              ...
              <div className="flex w-full md:w-auto">
                <input
                  ...
                  className="px-4 py-2 rounded-l-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-white/50 transition-all duration-300 flex-1 md:w-48"
                />
                <Button className="bg-teal-500 hover:bg-teal-600 px-4 md:px-6 py-2 rounded-r-full hover:scale-105 transition-all duration-300 whitespace-nowrap">
                  {t("subscribe")}
                </Button>
              </div>
            </div>
